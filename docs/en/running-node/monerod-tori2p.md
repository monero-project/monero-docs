...
??? question "Why use anonymity networks?"
    ...
    **Tor and I2P hidden services for wallet interface** are useful for wallet users because it bypasses NATA and also works to mitigates MiTM risks (which are very real). Hidden service connections are end-to-end encrypted and private by default.
...
??? question "Why different P2P ports for clearnet and onion/i2p?"
