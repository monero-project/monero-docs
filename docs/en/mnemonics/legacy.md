...
The legacy mnemonic scheme is the oldest and most widely-used mnemonic scheme in the Monero ecosystem. It composes a total of 25 words, where the first 24 words are for seed and the last word is for checksum. The checksum word is used to verify the correctness of the seed.
